...
####remove hashes to run different sensitivity analyses

###Datasets with >9 independent units (sample size >9) in both impact and control
eftest1 = subset(eftest,eftest$datasetID==5|
                   eftest$datasetID==11|
                   eftest$datasetID==12|
                   eftest$datasetID==21|
                   eftest$datasetID==26|
...
###Datasets with >5 independent units (sample size >5) in both impact and control
eftest1 = subset(eftest,eftest$datasetID==1|
                   eftest$datasetID==5|
                   eftest$datasetID==11|
                   eftest$datasetID==12|
                   eftest$datasetID==19|
...
####Datasets with >=2 years/time intervals before AND after impact
eftest1 = subset(eftest,eftest$datasetID==2|
                   eftest$datasetID==9|
                   eftest$datasetID==14|
                   eftest$datasetID==16|
                   eftest$datasetID==20|
...
badir2d=list()
cidir2d=list()
for(i in 1:length(unique(eftest1$datasetID))){
  bacidirhalf[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Direction" & eftest1$sample_size=="50%" & eftest1$design=="BACI")],na.rm=TRUE)
  bacidirthird[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Direction" & eftest1$sample_size=="33%" & eftest1$design=="BACI")],na.rm=TRUE)
  
  badirhalf[[i]] = mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Direction" & eftest1$sample_size=="50%" & eftest1$design=="BA")],na.rm=TRUE)
  badirthird[[i]]= mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Direction" & eftest1$sample_size=="33%" & eftest1$design=="BA")],na.rm=TRUE)
  
  
  cidirhalf[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Direction" & eftest1$sample_size=="50%" & eftest1$design=="CI")],na.rm=TRUE)
  cidirthird[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Direction" & eftest1$sample_size=="33%" & eftest1$design=="CI")],na.rm=TRUE)
  
  badir2d[[i]] = mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Direction" & eftest1$sample_size=="100%" & eftest1$design=="BA")],na.rm=TRUE)
  cidir2d[[i]] = mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Direction" & eftest1$sample_size=="100%" & eftest1$design=="CI")],na.rm=TRUE)
...
cidirhalfd[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
             which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA
cidirthirdd[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
              which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

rctdirhalfd[setdiff(1:length(rctdirhalfd),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                            which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rctdirthirdd[setdiff(1:length(rctdirthirdd),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                              which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA

rbacidirhalfd[setdiff(1:length(rctdirhalfd),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                              which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rbacidirthirdd[setdiff(1:length(rctdirthirdd),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
...
badir2d[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
          which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

cidir2d[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
          which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

rctdir2d[setdiff(1:length(rctdir2d),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                      which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
...
cidir2=list()
for(i in 1:length(unique(eftest1$datasetID))){
  bacidirhalf[[i]]  =  abs((mean(abs(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Deviation" & eftest1$sample_size=="50%" & eftest1$design=="BACI" & is.infinite(eftest1$result)==FALSE)]),na.rm=TRUE)))
  bacidirthird[[i]] =  abs((mean(abs(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Deviation" & eftest1$sample_size=="33%" & eftest1$design=="BACI" & is.infinite(eftest1$result)==FALSE)]),na.rm=TRUE)))
  
  badirhalf[[i]]  =  abs((mean(abs(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Deviation" & eftest1$sample_size=="50%" & eftest1$design=="BA" & is.infinite(eftest1$result)==FALSE)]),na.rm=TRUE)))
  badirthird[[i]] =  abs((mean(abs(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Deviation" & eftest1$sample_size=="33%" & eftest1$design=="BA" & is.infinite(eftest1$result)==FALSE)]),na.rm=TRUE)))
  
  cidirhalf[[i]]  =  abs((mean(abs(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Deviation" & eftest1$sample_size=="50%" & eftest1$design=="CI" & is.infinite(eftest1$result)==FALSE)]),na.rm=TRUE)))
  cidirthird[[i]] =  abs((mean(abs(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Deviation" & eftest1$sample_size=="33%" & eftest1$design=="CI" & is.infinite(eftest1$result)==FALSE)]),na.rm=TRUE)))
  
  badir2[[i]] = abs((mean(abs(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Deviation" & eftest1$sample_size=="100%" & eftest1$design=="BA" & is.infinite(eftest1$result)==FALSE)]),na.rm=TRUE)))
  cidir2[[i]] = abs((mean(abs(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Deviation" & eftest1$sample_size=="100%" & eftest1$design=="CI" & is.infinite(eftest1$result)==FALSE)]),na.rm=TRUE)))
...
badirhalf[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
            which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA
badirthird[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
             which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

cidirhalf[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
            which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA
cidirthird[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
             which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

rctdirhalf[setdiff(1:length(rctdirhalf),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                          which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rctdirthird[setdiff(1:length(rctdirthird),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                            which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA

rbacidirhalf[setdiff(1:length(rctdirhalf),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                            which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rbacidirthird[setdiff(1:length(rctdirthird),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                              which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
...
badir2[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
         which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

cidir2[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
         which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

rctdir2[setdiff(1:length(rctdir2),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                    which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
...
for(i in 1:length(unique(eftest1$datasetID))){
  bacidirhalfund[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Underestimation" & eftest1$sample_size=="50%" & eftest1$design=="BACI")],na.rm=TRUE)
  bacidirthirdund[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Underestimation" & eftest1$sample_size=="33%" & eftest1$design=="BACI")],na.rm=TRUE)
  
  badirhalfund[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Underestimation" & eftest1$sample_size=="50%" & eftest1$design=="BA")],na.rm=TRUE)
  badirthirdund[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Underestimation" & eftest1$sample_size=="33%" & eftest1$design=="BA")],na.rm=TRUE)
  
  cidirhalfund[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Underestimation" & eftest1$sample_size=="50%" & eftest1$design=="CI")],na.rm=TRUE)
  cidirthirdund[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Underestimation" & eftest1$sample_size=="33%" & eftest1$design=="CI")],na.rm=TRUE)
  
  
  bacidirhalfover[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Overestimation" & eftest1$sample_size=="50%" & eftest1$design=="BACI")],na.rm=TRUE)
  bacidirthirdover[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Overestimation" & eftest1$sample_size=="33%" & eftest1$design=="BACI")],na.rm=TRUE)
  
  badirhalfover[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Overestimation" & eftest1$sample_size=="50%" & eftest1$design=="BA")],na.rm=TRUE)
  badirthirdover[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Overestimation" & eftest1$sample_size=="33%" & eftest1$design=="BA")],na.rm=TRUE)
  
  cidirhalfover[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Overestimation" & eftest1$sample_size=="50%" & eftest1$design=="CI")],na.rm=TRUE)
  cidirthirdover[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Overestimation" & eftest1$sample_size=="33%" & eftest1$design=="CI")],na.rm=TRUE)
  
  
  bacidirhalfcorr[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Non-coverage" & eftest1$sample_size=="50%" & eftest1$design=="BACI")],na.rm=TRUE)
  bacidirthirdcorr[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Non-coverage" & eftest1$sample_size=="33%" & eftest1$design=="BACI")],na.rm=TRUE)
  
  badirhalfcorr[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Non-coverage" & eftest1$sample_size=="50%" & eftest1$design=="BA")],na.rm=TRUE)
  badirthirdcorr[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Non-coverage" & eftest1$sample_size=="33%" & eftest1$design=="BA")],na.rm=TRUE)
  
  cidirhalfcorr[[i]]  =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Non-coverage" & eftest1$sample_size=="50%" & eftest1$design=="CI")],na.rm=TRUE)
  cidirthirdcorr[[i]] =  mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Non-coverage" & eftest1$sample_size=="33%" & eftest1$design=="CI")],na.rm=TRUE)
  
  
  badir2und[[i]] = mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Underestimation" & eftest1$sample_size=="100%" & eftest1$design=="BA")],na.rm=TRUE)
  cidir2und[[i]] = mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Underestimation" & eftest1$sample_size=="100%" & eftest1$design=="CI")],na.rm=TRUE)
  
  badir2over[[i]] = mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Overestimation" & eftest1$sample_size=="100%" & eftest1$design=="BA")],na.rm=TRUE)
  cidir2over[[i]] = mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Overestimation" & eftest1$sample_size=="100%" & eftest1$design=="CI")],na.rm=TRUE)
  
  badir2corr[[i]] = mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Non-coverage" & eftest1$sample_size=="100%" & eftest1$design=="BA")],na.rm=TRUE)
  cidir2corr[[i]] = mean(eftest1$result[which(eftest1$datasetID==unique(eftest1$datasetID)[i] & eftest1$measure=="Non-coverage" & eftest1$sample_size=="100%" & eftest1$design=="CI")],na.rm=TRUE)
...
badirhalfund[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
               which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA
badirthirdund[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

cidirhalfund[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
               which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA
cidirthirdund[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

rctdirhalfund[setdiff(1:length(rctdirhalfund),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rctdirthirdund[setdiff(1:length(rctdirthirdund),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                  which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rbacidirhalfund[setdiff(1:length(rctdirhalfund),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                  which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rbacidirthirdund[setdiff(1:length(rctdirthirdund),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                    which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
...
badirhalfover[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA
badirthirdover[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                 which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

cidirhalfover[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA
cidirthirdover[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                 which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

rctdirhalfover[setdiff(1:length(rctdirhalfover),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                  which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rctdirthirdover[setdiff(1:length(rctdirthirdover),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                    which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rbacidirhalfover[setdiff(1:length(rctdirhalfover),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                    which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rbacidirthirdover[setdiff(1:length(rctdirthirdover),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                      which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
...
badirhalfcorr[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA
badirthirdcorr[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                 which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

cidirhalfcorr[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA
cidirthirdcorr[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                 which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

rctdirhalfcorr[setdiff(1:length(rctdirhalfcorr),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                  which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rctdirthirdcorr[setdiff(1:length(rctdirthirdcorr),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                    which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rbacidirhalfcorr[setdiff(1:length(rctdirhalfcorr),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                    which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rbacidirthirdcorr[setdiff(1:length(rctdirthirdcorr),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                                      which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
...
cidir2und[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
            which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

rctdir2und[setdiff(1:length(rctdir2und),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                          which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA


rctdir2over=cidir2over

cidir2over[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
             which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

rctdir2over[setdiff(1:length(rctdir2over),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                            which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
rctdir2corr=cidir2corr

cidir2corr[c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
             which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53))] = NA

rctdir2corr[setdiff(1:length(rctdir2corr),c(which(unique(eftest1$datasetID)==4),which(unique(eftest1$datasetID)==36),which(unique(eftest1$datasetID)==37),
                                            which(unique(eftest1$datasetID)==51),which(unique(eftest1$datasetID)==53)))] = NA
